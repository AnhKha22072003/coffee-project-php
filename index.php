...
<?php
	...
	$productAll = $products->fetchAll(PDO::FETCH_OBJ);
?>
			...
			<div class="book p-4">
				...
				<form action="booking/book.php" method="post" class="appointment-form">
					...
					<div class="d-md-flex">
						...
						<div class="form-group ml-md-4">
							<input type="submit" name="submit" value="Appointment" class="btn btn-white py-3 px-4">
						</div>
					</div>
				</form>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			<?php foreach ($productAll as $product): ?>
				<div class="col-md-3">
					<div class="menu-entry">
						<a href="products/product-single.php?id=<?php echo $product->id ?>" class="img" style="background-image: url(<?php echo BASE_URL?>/images/<?php echo $product->image ?>);"></a>
